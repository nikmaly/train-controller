...
class MotorDriver {
  private:
    ...
    void logState() {
      Serial.println(motorName + " current state: direction=" + currentDirection + ", speed=" + String(currentSpeed) + "%");
    }
  ...
  public:
     ...
     */
    MotorDriver(int outPwm, int outDirection1, String motorName, bool dualDirectionPin = false, int outDirection2 = -1) {
      this->outPwm = outPwm;
